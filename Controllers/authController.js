...
//   // If no email provided, generate a random email
//   let email = req.body.email || `random_${Math.random()}@example.com`;

//   // If no contact provided, generate a random contact number
//   let contact =
//     req.body.contact || Math.floor(Math.random() * 10000000000).toString();
...
//   if (!deviceData || !deviceData.id || !deviceData.deviceToken) {
//     return next(new AppError("Please provide deviceId and DeviceToken", 400));
//   }
...
//     otp: null,
//     passwordChangedAt: Date.now(),
//     location: req.body.location || undefined, // Optional location
//   });
